...
class MTActivity : ComponentActivity() {
        ...
        setContent {
            ...
            )
            {
                ...
                )
                {
                    ...
                    {
                        IconButton(onClick = {
                            val navigate = Intent(this@MTActivity, MainActivity::class.java)
                        ...
                        Image(
                            painter = rememberAsyncImagePainter(
                                model = "https://i.pinimg.com/736x/18/23/a3/1823a333d1e0f86ec1982b3aa19c0582.jpg",
